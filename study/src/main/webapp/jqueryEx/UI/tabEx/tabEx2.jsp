...
$(function(){
	$('#tab-container').tabs({
	      beforeLoad: function(event, ui){
		       ui.ajaxSettings.url+="?temp="+new Date().getTime();
		}
	});
});	

- 특정 탭에 html을 대입 
$("#tab-container .ui-tabs-panel").eq(2).html("예제..."); 
...
$(function(){
	...
	// $("#tab-container").tabs("option", "active", 1); // 1) 번 실행후 실행해야함
});
</script>
...
<div class="container" id="tab-container">
	<ul>
		<li><a href="t1.jsp"><span>첫번째</span></a></li>
		<li><a href="t2.jsp"><span>두번째</span></a></li>
		<li><a href="t3.jsp"><span>세번째</span></a></li>
	</ul>
</div>
