				...
				<ul class="navbar-nav mx-auto flex-nowrap"> <!-- ms-auto : 우측으로 정렬 -->
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/sbbs/list.do?category=1">프로그래밍</a></li>
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/sbbs/list.do?category=2">데이터베이스</a></li>
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/sbbs/list.do?category=3">웹프로그래밍</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/guest/main.do">방명록</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/mail/send.do">메일</a></li>
	                    ...
	                    <form name="modelLoginForm" action="" method="post" class="row g-3">
	                        ...
	                        <div>
	                    		 <p class="form-control-plaintext text-center">
	                    		 	<a href="${pageContext.request.contextPath}/member/pwdFind.do" class="text-decoration-none me-2">패스워드를 잊으셨나요 ?</a>
	                    		 </p>
	                    	</div>
	                    </form>
	                    <hr class="mt-3">
