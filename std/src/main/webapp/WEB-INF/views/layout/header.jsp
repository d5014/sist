...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<nav>
		<ul class="main-menu">
			...
			<li><a href="#">커뮤니티</a>
				<ul class="sub-menu">
					<li><a href="${pageContext.request.contextPath}/guest/main.do" aria-label="submenu">방명록</a></li>
					<li><a href="${pageContext.request.contextPath}/bbs/list.do" aria-label="submenu">게시판</a></li>
					<li><a href="${pageContext.request.contextPath}/photo/list.do" aria-label="submenu">포토갤러리</a></li>
			...
			<li><a href="#">스터디룸</a>
				<ul class="sub-menu">
					<li><a href="${pageContext.request.contextPath}/sbbs/list.do?category=1" aria-label="submenu">프로그래밍</a></li>
					<li><a href="${pageContext.request.contextPath}/sbbs/list.do?category=2" aria-label="submenu">데이터베이스</a></li>
					<li><a href="${pageContext.request.contextPath}/sbbs/list.do?category=3" aria-label="submenu">웹프로그래밍</a></li>
			...
			<li><a href="#">고객센터</a>
				<ul class="sub-menu">
					...
					<li><a href="${pageContext.request.contextPath}/notice/list.do" aria-label="submenu">공지사항</a></li>
					<li><a href="${pageContext.request.contextPath}/board/list.do" aria-label="submenu">질문과 답변</a></li>
			...
			<li><a href="#">마이페이지</a>
				<ul class="sub-menu">
					<li><a href="${pageContext.request.contextPath}/sphoto/list.do" aria-label="submenu">포토앨범</a></li>
