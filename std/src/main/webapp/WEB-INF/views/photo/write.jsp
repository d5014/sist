...
.table-form .img { width: 37px; height: 37px; border: none; vertical-align: middle; }
.table-form .info { vertical-align: middle; font-size: 11px; color: #333; }
</style>
...
<main>
	<div class="container body-container">
	    <div class="body-title">
			<h2><i class="far fa-image"></i> 포토 갤러리 </h2>
	    </div>
