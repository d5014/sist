...
<c:url var="listUrl" value="/bbs/list.do">
	<c:if test="${not empty keyword}"><!-- 검색이면 자동으로 condition과 keyword 파라미터를 넘김 -->
		<c:param name="condition" value="${condition}"/>
		<c:param name="keyword" value="${keyword}"/>
	</c:if>
</c:url>

<script type="text/javascript" src="${pageConte   xt.request.contextPath}/resource/js/paginate.js"></script>
